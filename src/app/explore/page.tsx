...
export default function ExploreOverviewPage() {
  ...
  return (
    <div className="animate-fade-up">
      <span className="inline-flex items-center gap-1.5 rounded-full border border-indigo-400/30 bg-indigo-500/10 px-3 py-1 text-xs font-medium text-indigo-300 light:border-indigo-500/30 light:text-indigo-700">
        ✨ อัปเดตล่าสุด 25 สิงหาคม 2026
      </span>
      <h1 className="mt-4 text-2xl font-semibold tracking-tight text-neutral-50 sm:text-3xl light:text-neutral-900">
        สำรวจหมวดหมู่ AI ทั้งหมด
      </h1>
      <p className="mt-2 max-w-xl text-neutral-400 light:text-neutral-600">
      ...
      <div className="mt-8 flex flex-wrap gap-8 rounded-2xl border border-white/10 bg-white/[0.03] p-6 light:border-black/10 light:bg-black/[0.03]">
        <div>
          <div className="text-2xl font-semibold text-neutral-50 light:text-neutral-900">
            {groups.length}
          </div>
      ...
      <p className="mt-6 max-w-2xl rounded-lg border border-amber-400/20 bg-amber-500/10 px-4 py-3 text-sm text-amber-300 light:border-amber-400/30 light:bg-amber-50 light:text-amber-700">
